...
abstract class KeycontainerexBackend {
  Future<String> helloFromFrb({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kHelloFromFrbConstMeta;
}
...
class KeycontainerexBackendImpl implements KeycontainerexBackend {
  ...
  Future<String> helloFromFrb({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_hello_from_frb(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kHelloFromFrbConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
...
class KeycontainerexBackendWire implements FlutterRustBridgeWireBase {
  ...
  void wire_hello_from_frb(
    int port_,
  ) {
    return _wire_hello_from_frb(
      port_,
    );
  }

  late final _wire_hello_from_frbPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_hello_from_frb');
  late final _wire_hello_from_frb =
      _wire_hello_from_frbPtr.asFunction<void Function(int)>();
